...
const features = [
  {
    label: "Practice",
    title: "895 exam questions with detailed explanations",
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-10 lg:py-12 lg:border-r border-border">
              ...
              >
                <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
                  Practice with 895 questions including Master Level problems covering advanced calculations, 
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="space-y-1">
                    <div className="text-4xl font-display font-bold">895</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  This comprehensive test draws from our entire question bank of 895 questions, covering all exam topics 
